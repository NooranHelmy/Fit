...
Mesh* MeshUtils::Box(){
    std::vector<Vertex> vertices = {
        //Upper Face
        {{-1,  1, -1}, WHITE, {0, 0}, {0, 1, 0}},
        {{-1,  1,  1}, WHITE, {1, 0}, {0, 1, 0}},
        {{ 1,  1,  1}, WHITE, {1, 1}, {0, 1, 0}},
        {{ 1,  1, -1}, WHITE, {0, 1}, {0, 1, 0}},
        //Lower Face
        {{-1, -1, -1}, WHITE, {0, 0}, {0, -1, 0}},
        {{ 1, -1, -1}, WHITE, {1, 0}, {0, -1, 0}},
        {{ 1, -1,  1}, WHITE, {1, 1}, {0, -1, 0}},
        {{-1, -1,  1}, WHITE, {0, 1}, {0, -1, 0}},
        //Right Face
        {{ 1, -1, -1}, WHITE, {0, 0}, {1, 0, 0}},
        {{ 1,  1, -1}, WHITE, {1, 0}, {1, 0, 0}},
        {{ 1,  1,  1}, WHITE, {1, 1}, {1, 0, 0}},
        {{ 1, -1,  1}, WHITE, {0, 1}, {1, 0, 0}},
        //Left Face
        {{-1, -1, -1}, WHITE, {0, 0}, {-1, 0, 0}},
        {{-1, -1,  1}, WHITE, {1, 0}, {-1, 0, 0}},
        {{-1,  1,  1}, WHITE, {1, 1}, {-1, 0, 0}},
        {{-1,  1, -1}, WHITE, {0, 1}, {-1, 0, 0}},
        //Front Face
        {{-1, -1,  1}, WHITE, {0, 0}, {0, 0, 1}},
        {{ 1, -1,  1}, WHITE, {1, 0}, {0, 0, 1}},
        {{ 1,  1,  1}, WHITE, {1, 1}, {0, 0, 1}},
        {{-1,  1,  1}, WHITE, {0, 1}, {0, 0, 1}},
        //Back Face
        {{-1, -1, -1}, WHITE, {0, 0}, {0, 0, -1}},
        {{-1,  1, -1}, WHITE, {1, 0}, {0, 0, -1}},
        {{ 1,  1, -1}, WHITE, {1, 1}, {0, 0, -1}},
